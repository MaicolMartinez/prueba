...
<body>
    ...
    <form class="form" action="../controllers/usuario/saveusu.php" method="POST"  enctype="multipart/form-data">
        <h2>Usuario</h2>
        <p type="Numero de Identificación:"><input name="n_iden" placeholder=".."  ></input></p>
