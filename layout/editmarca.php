...
<head>
    ...
    <?php require_once '../models/marca.php' ?>
...
<body>
    ...
    <form class="form" action="../controllers/marca/update.php?ID_MARCA=<?=$marca->ID_MARCA?>" method="POST"  enctype="multipart/form-data">
        <h2>Tipo de equipo </h2>
        
        <p type="Nombre:"><input name="nombre" value="<?=$marca->NOMBRE ?>"></input></p>
